// PgCPP.DLL.9.x.cpp : Defines the exported functions for the DLL application.
//
...
global variables
*/
PGCPPDLL9X_API char* colums_ = nullptr;
PGCPPDLL9X_API PGconn* conn_ = nullptr;
PGCPPDLL9X_API vector<char*>* rows_ = nullptr;
PGCPPDLL9X_API char* tableName_ = nullptr;
PGCPPDLL9X_API int batchSize_ = 0;
